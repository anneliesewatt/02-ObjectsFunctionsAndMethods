...
def try_methods():
    ...
    ###########################################################################
Alice = rg.SimpleTurtle ('square')
Alice.pen = rg.Pen ('brown', 5)
Alice.forward(150)
Alice.left(90)
Alice.forward(50)
Alice.backward(100)
...
greg.pen = rg.Pen ('blue',5)
greg.backward(150)
greg.speed = (1)
for k in range(2):
    greg.draw_square(100)
    greg.left(30)
greg.speed = (5)
...
for k in range(10):
    ...
    greg.left(15)
greg.speed = (100)
greg.pen = rg.Pen ('red',35)
for k in range (8):
    greg.draw_square(300)
    greg.left(60)
greg.pen = rg.Pen ('black', 3)
greg.backward(200)
greg.draw_circle(30)
greg.draw_square(50)
